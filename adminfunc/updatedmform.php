...
<form action="admin.php?act=updatedmform" method="post" onsubmit="return check();">
    <h2>CẬP NHẬT DANH MỤC SẢN PHẨM</h2>
    <label>Tên danh mục</label>

    <input type="text" name="tendm" id="tendm" value="<?=$kq1[0]['tendm'] ?>"><br>
    <label>Thứ tự ưu tiên</label>
    <input type="number" name="uutien" id="uutien" value="<?=$kq1[0]['uutien'] ?>"><br>
    <label>Thứ tự hiển thị </label>
    <input type="number" name="hienthi" id="hienthi" value="<?=$kq1[0]['hienthi'] ?>"><br>
